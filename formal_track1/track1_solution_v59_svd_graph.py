...
def build_svd_embeddings(
    ...
    log(f"  building directed graph SVD embeddings dim={actual_dim}")
    src = train["src"].to_numpy(np.int64, copy=False)
...
def main():
    ...
    parser.add_argument("--ranker_feature_profile", choices=["v42", "v51", "v58", "v59", "mild", "sharp", "core"], default="v59")
