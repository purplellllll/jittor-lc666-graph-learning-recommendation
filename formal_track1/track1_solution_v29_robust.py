...
def ranker_feature_names():
    ...
    names.extend(["v18_score", "v18_norm", "v18_inv_rank", "pos_norm", "inv_pos"])
    return names
...
def main():
    ...
    parser.add_argument("--ranker_rows", type=int, default=165000)
    ...
    parser.add_argument("--ranker_trees", type=int, default=560)
