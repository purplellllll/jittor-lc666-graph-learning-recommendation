...
def selected_ranker_feature_names(no_pos: bool = False):
    names = []
    keep_exact = {
        "log_pair_cnt",
        "pair_rec",
...
def selected_ranker_feature_indices(no_pos: bool = False):
    selected = set(selected_ranker_feature_names(no_pos=no_pos))
    return np.array(
...
def train_ranker(train: pd.DataFrame, test: pd.DataFrame, name: str, args):
    ...
    if args.ranker_all_features:
        ...
        feature_idx = selected_ranker_feature_indices(no_pos=args.ranker_no_pos)
    ...
    log(
        ...
        f"(no_pos={args.ranker_no_pos}, all_features={args.ranker_all_features})"
    )
...
def main():
    ...
    parser.add_argument("--ranker_no_pos", action="store_true")
